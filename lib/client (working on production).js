...
function Client (options) {
  ...
  this.endpoint = this.options.endpoint || 'http://www3.inegi.org.mx/sistemas/api/denue/v1/consulta/buscar'
...
// Client.prototype.search = function (place, options, callback) {
//   var uri
...
//     callback = options
//   }
//   this._request(uri, 'GET', callback)
// }
